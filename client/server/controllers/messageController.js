//test based AI chat controllers
...
// image generation message controllers 
...
export const imageMessageController = async (req , res) => {
    try{
        ...
        // construct imagekit AI geneeration url 
        ...
        // triggers generation by the yhe image kit

       const aiImageResponse =  await axios.get(generatedImageUrl, {responseType: "arraybuffer"})

       // convert to the base64
