  ...
  return (
    ...
    {images.length > 0 ? (
      ...
      {images.map((item , index) =>(
        <a key={index}  href={item.imageUrl} className='relative group block rounded-lg overflow-hidden
        ...
        2xl:h-62 object-cover group-hover:scale-105 transistion-transform
